...
#After importing the necessary classes from media and fres_tomatoes, we instanciate 3 objects of Movie
...
#After instanciate 3 objects of Movie, we create a list of the Movie objects that we want to use in our webpage 

movies=[pi,braveheart,requiem_fa_dream]

#After creation the necessary list that fresh_tomatoes expect, we send that list to the constructor of the webpage
