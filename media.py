...
# After creating the Parent class, we create two Childs 
# (Movie and Serie) that will inherit all the
...
class Serie(Video):
	def __init__(self, trailer_youtube_url, poster_image_url, title, actors, season):
		Video.__init__(self, trailer_youtube_url, poster_image_url, title, actors)
		self.season=season